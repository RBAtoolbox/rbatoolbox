...
%   This function is similar to rbaMeasurement but uses a more time
%   efficient procedure. This function will be implemented in
%   rbaAverageMeasurement in the future.
%
%   Usage: y = rbaAverageMeasurement(signal, fs, N)
%
%   Input parameters:
...
PsychPortAudio('GetAudioData', recHandle, length(signal)+totalLatency+compTime);
